...
class BiAnImage():
    ...
    def save_image(self, image_url):
        ...
        with open("../images/%s" % image_url[-6:], 'wb') as f:
            f.write(content)
            print(image_url[-6:], "下载完成...")
...
bi_an = BiAnImage()
image_url = "http://pic.netbian.com/uploads/allimg/190713/104025-15629856250f21.jpg"
bi_an.save_image(image_url)
